...
export default function Services() {
  ...
  const allServices = [
    ...
    {
      name: "Услуги по земле",
      description: "Оформление земельных участков и кадастровые работы",
      price: "от 25 000 ₽",
      features: ["Межевание участков", "Оформление документов", "Смена категории земли", "Разрешения на строительство"],
      icon: "🗺️"
    },
    {
      name: "Подбор участка",
      description: "Поиск идеального участка для строительства дома",
      price: "от 100 000 ₽",
      features: ["Анализ рынка", "Проверка документов", "Геология и инженерия", "Сопровождение сделки"],
      icon: "📍"
    },
    {
