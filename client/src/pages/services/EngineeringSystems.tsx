...
export default function EngineeringSystems() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-cyan-600 to-cyan-500 text-text-primary py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="border-white text-text-primary hover:bg-white hover:text-cyan-600 px-8 py-4 text-lg">
                Примеры работ
              </Button>
            </div>
          </div>
            ...
            {systems.map((system, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <Badge className="bg-cyan-500 text-text-primary w-fit">
                    {system.price}
                  </Badge>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full bg-cyan-500 text-text-primary hover:bg-cyan-600">
                    Узнать подробнее
                  </Button>
                </CardContent>
              </Card>
          ...
          <div className="max-w-4xl mx-auto">
            {process.map((item, index) => (
              <div key={index} className="flex items-start mb-8 last:mb-0">
                <div className="flex-shrink-0 w-16 h-16 bg-cyan-500 text-text-primary rounded-full flex items-center justify-center font-bold text-lg mr-6">
                  {item.step}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-cyan-600 to-cyan-500 text-text-primary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
