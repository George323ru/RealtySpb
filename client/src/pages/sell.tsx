...
export default function Sell() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-green-900 via-emerald-900 to-teal-900 py-20 min-h-[70vh] flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-green-900/80 via-transparent to-teal-900/80"></div>
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
              <div className="bg-white/15 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl hover:bg-white/20 transition-all duration-300">
                ...
                <div className="text-base text-white/90 font-medium">Выше рыночной цены</div>
              </div>
              <div className="bg-white/15 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl hover:bg-white/20 transition-all duration-300">
                <div className="text-4xl font-bold text-yandex-yellow mb-3 drop-shadow-lg">45</div>
                <div className="text-base text-white/90 font-medium">Дней средний срок</div>
              </div>
              <div className="bg-white/15 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl hover:bg-white/20 transition-all duration-300">
                <div className="text-4xl font-bold text-yandex-yellow mb-3 drop-shadow-lg">100%</div>
                <div className="text-base text-white/90 font-medium">Юридическая чистота</div>
              </div>
            </div>
          </div>
        </div>
