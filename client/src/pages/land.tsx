    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-green-600 text-foreground rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                  {item.step}
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-8 text-foreground text-center">
