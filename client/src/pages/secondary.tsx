          ...
          <div className="max-w-4xl mx-auto text-center text-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6">
                <div className="text-3xl font-bold text-yandex-yellow mb-2">{properties.length}</div>
                <div className="text-sm">Объектов в каталоге</div>
              </div>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6">
                <div className="text-3xl font-bold text-yandex-yellow mb-2">18</div>
                <div className="text-sm">Районов города</div>
              </div>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6">
                <div className="text-3xl font-bold text-yandex-yellow mb-2">100%</div>
                <div className="text-sm">Проверенных объектов</div>
              </div>
            </div>
          </div>
        </div>
